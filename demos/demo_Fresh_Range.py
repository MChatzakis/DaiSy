...
from daisy import DistanceType, SearchConfig, QueryType, Fresh, BruteForceSearch
...
def main():
    ...
    index = Fresh(DistanceType.L2_SQUARED)
    ...
    print(f"=== Fresh Range Search (r={r:.1f}) ===")
    ...
    for qi in range(n_query):
        ...
        print(f"  Query {qi}: Fresh={len(I[qi])}, BruteForce={len(I_bf[qi])}, sets equal={match}")
