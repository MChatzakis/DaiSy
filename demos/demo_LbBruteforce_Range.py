...
from daisy import DistanceType, SearchConfig, QueryType, LbBruteforce, BruteForceSearch
...
def main():
    ...
    index = LbBruteforce(DistanceType.L2_SQUARED)
    ...
    print(f"=== LbBruteforce Range Search (r={r:.1f}) ===")
    ...
    for qi in range(n_query):
        ...
        print(f"  Query {qi}: LbBruteforce={len(I[qi])}, BruteForce={len(I_bf[qi])}, sets equal={match}")
