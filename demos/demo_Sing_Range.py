...
from daisy import DistanceType, SearchConfig, QueryType, Sing, BruteForceSearch
...
def main():
    ...
    index = Sing(DistanceType.L2_SQUARED)
    ...
    print(f"=== Sing Range Search (r={r:.1f}) ===")
    ...
    for qi in range(n_query):
        ...
        print(f"  Query {qi}: Sing={len(I[qi])}, BruteForce={len(I_bf[qi])}, sets equal={match}")
