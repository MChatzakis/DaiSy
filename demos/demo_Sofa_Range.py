...
from daisy import DistanceType, SearchConfig, QueryType, Sofa, BruteForceSearch
...
def main():
    ...
    index = Sofa(DistanceType.L2_SQUARED)
    ...
    print(f"=== Sofa Range Search (r={r:.1f}) ===")
    ...
    for qi in range(n_query):
        ...
        print(f"  Query {qi}: Sofa={len(I[qi])}, BruteForce={len(I_bf[qi])}, sets equal={match}")
