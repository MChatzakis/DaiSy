// Messi range search: report every series within squared-L2 distance r of a query.
...
int main()
{
    ...
    messi_search.searchIndex(query, n_query, config, I, D);
    reportRange("Messi", r, I, D);
    ...
    printf("\nAll queries match: %s\n",
           matchesBruteforce("Messi", I, gt_I) ? "yes" : "no");
